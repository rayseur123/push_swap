...
void		lst_pa(t_list_push **b, t_list_push **a,
				t_data *data_b, t_data *data_a);
void		lst_pb(t_list_push **a, t_list_push **b,
...
// search sort
int			search_opti(int mid, int val_max,
				t_sort_datas *sd, t_search_data search);
